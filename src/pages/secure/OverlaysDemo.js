			...
			<div className="p-grid p-fluid">
				<div className="p-col-12 p-lg-6">
					...
					<div className="card">
						...
						<Button icon="pi-md-launch" label="Show" onClick={() => this.setState({ display: true })} />
					</div>
				</div>
				<div className="p-col-12 p-lg-6">
					<div className="card">
					...
					<div className="card">
						<h1>Tooltip</h1>
						<InputText tooltip="Enter Username" tooltipOptions={{ position: 'bottom' }} />
					</div>
				</div>
			</div>
		);
...
export default withSecurity(withSecureLayout(OverlaysDemo));
