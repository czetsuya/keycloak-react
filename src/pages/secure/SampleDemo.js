...
class SampleDemo extends Component {
	constructor() {
		...
		this.state = {
			...
			splitButtonItems: [
				{ label: 'Update', icon: 'pi-md-update' },
				{ label: 'Delete', icon: 'pi-md-close' },
				{ label: 'Home', icon: 'pi-md-home', url: 'http://www.primefaces.org/primereact' }
			],
			menuItems: [
				{
					label: 'File',
		...
		return (
			<div className="p-clearfix">
				<img
					...
					alt={car.brand}
					style={{ display: 'inline-block', margin: '2px 0 2px 2px', width: '50px' }}
				/>
			...
			return (
				<div style={{ padding: '.5em' }} className="p-col-12 p-md-3">
					<Panel header={car.vin} style={{ textAlign: 'center' }}>
						<img src={`assets/demo/images/car/${car.brand}.gif`} alt={car.brand} />
	...
	render() {
		const dialogFooter = (
			<Button label="Login" icon="pi-md-person" onClick={() => this.setState({ dialogValue: false })} />
		);
					...
					<div className="p-col-12">
						...
						>
							<div className="p-messages-wrapper">
								<ul>
									<li>
										<span className="p-messages-icon pi-md-check" />
										<span className="p-messages-detail">
											Ultima provides a theme for all 70+ PrimeReact Components. This page
											contains samples of the commonly used components for demo purposes.
										</span>
									</li>
								</ul>
							</div>
						...
						<div className="card card-w-title">
							...
							<div className="p-grid">
								...
								<div className="p-col-12 p-md-4">
									<InputTextarea id="textarea" rows={3} cols={30} autoResize={true} />
								</div>
								<div className="p-col-12 p-md-2">
								...
								<div className="p-col-12 p-md-4">
									<AutoComplete
										...
										completeMethod={this.filterCountry}
										value={this.state.country}
										onChange={event =>
											this.setState({ country: event.value, filteredCountries: null })}
									/>
								</div>
								<div className="p-col-12 p-md-2">
								...
								<div className="p-col-12 p-md-4">
									<Spinner
										...
										onChange={event => this.setState({ spinnerValue: event.value })}
									/>
								</div>
									...
									<div className="p-grid">
										<div className="p-col-12">
											<Checkbox
												...
												checked={this.state.checkboxValue.indexOf('Ultima') > -1}
											/>
										...
										<div className="p-col-12">
											<Checkbox
												...
												inputId="cb2"
												onChange={this.onCheckboxChange}
												checked={this.state.checkboxValue.indexOf('Avalon') > -1}
											/>
										...
										<div className="p-col-12">
											<Checkbox
												...
												inputId="cb3"
												onChange={this.onCheckboxChange}
												checked={this.state.checkboxValue.indexOf('Serenity') > -1}
											/>
									...
									<div className="p-grid">
										<div className="p-col-12">
											<RadioButton
												...
												checked={this.state.radioValue === 'Ultima'}
											/>
								...
								<div className="p-col-12 p-md-4">
									<Slider
										...
										onChange={event => this.setState({ sliderValue: event.value })}
									/>
								</div>
								<div className="p-col-12 p-md-2">Button</div>
								<div className="p-col-12 p-md-4">
									<Button label="Edit" icon="pi-md-pencil" />
								</div>
								<div className="p-col-12 p-md-2">SplitButton</div>
								<div className="p-col-12 p-md-4">
									<SplitButton label="Save" icon="pi-md-plus" model={this.state.splitButtonItems} />
								</div>
								<div className="p-col-12 p-md-2">
								...
								<div className="p-col-12 p-md-4">
									<MultiSelect
										id="multiselect"
										placeholder="Choose"
										value={this.state.selectedCars}
										options={this.state.carOptions}
										onChange={event => this.setState({ selectedCars: event.value })}
									/>
								</div>
								<div className="p-col-12 p-md-2">ToggleButton</div>
								<div className="p-col-12 p-md-4">
									<ToggleButton
										checked={this.state.toggleButtonValue}
										onChange={event => this.setState({ toggleButtonValue: event.value })}
									/>
								</div>
								...
								<div className="p-col-12 p-md-4">
									<SelectButton
										...
										onChange={event => this.setState({ selectedType: event.value })}
									/>
								</div>
								<div className="p-col-12 p-md-2">
								...
								<div className="p-col-12 p-md-4">
									<ListBox
										...
										onChange={event => this.setState({ listBoxCity: event.value })}
										filter={true}
									/>
								</div>
					...
					<div className="p-col-12 p-lg-6">
						...
						<div className="card card-w-title">
							...
							<OrderList
								...
								onChange={event => this.setState({ orderlistCars: event.value })}
							/>
						</div>
					...
					<div className="p-col-12 p-lg-6">
						<div className="card card-w-title">
							...
							<Accordion>
								<AccordionTab header="Godfather I">
									The story begins as Don Vito Corleone, the head of a New York Mafia family, oversees
									his daughters wedding. His beloved son Michael has just come home from the war, but
									does not intend to become part of his fathers business. Through Michaels life the
									nature of the family business becomes clear. The business of the family is just like
									the head of the family, kind and benevolent to those who give respect, but given to
									ruthless violence whenever anything stands against the good of the family.
								</AccordionTab>
								<AccordionTab header="Godfather II">
									Francis Ford Coppolas legendary continuation and sequel to his landmark 1972 film,
									The_Godfather parallels the young Vito Corleone's rise with his son Michael's
									spiritual fall, deepening The_Godfathers depiction of the dark side of the American
									dream. In the early 1900s, the child Vito flees his Sicilian village for America
									after the local Mafia kills his family. Vito struggles to make a living, legally or
									illegally, for his wife and growing brood in Little Italy, killing the local Black
									Hand Fanucci after he demands his customary cut of the tyro's business. With Fanucci
									gone, Vito's communal stature grows.
								</AccordionTab>
								<AccordionTab header="Godfather III">
									After a break of more than 15 years, director Francis Ford Coppola and writer Mario
									Puzo returned to the well for this third and final story of the fictional Corleone
									crime family. Two decades have passed, and crime kingpin Michael Corleone, now
									divorced from his wife Kay has nearly succeeded in keeping his promise that his
							...
							<h1>TabView</h1>
							<TabView>
								<TabPanel header="Godfather I" leftIcon="pi-md-check">
									The story begins as Don Vito Corleone, the head of a New York Mafia family,
									overseeshis daughter's wedding. His beloved son ichael has just come home from the
									war, but does not intend to become part of his father's business. Through Michael's
									life the nature of the family business becomes clear. The business of the family is
									just like the head of the family, kind and benevolent to those who give respect, but
									given to ruthless violence whenever anything stands against the good of the family.
								</TabPanel>
								<TabPanel header="Godfather II" leftIcon="pi-md-person">
									Francis Ford Coppola's legendary continuation and sequel to his landmark 1972 film,
									The_Godfather parallels the young Vito Corleone's rise with his son Michael's
									spiritual fall, deepening The_Godfather's depiction of the dark side of the American
									dream. In the early 1900s, the child Vito flees his Sicilian village for America
									after the local Mafia kills his family. Vito struggles to make a living, legally or
									illegally, for his wife and growing brood in Little Italy.
								</TabPanel>
								<TabPanel header="Godfather III">
									The Godfather Part III is set in 1979 and 1980. Michael has moved back to New York
									and taken great strides to remove the family from crime. He turns over his New York
									criminal interests to longtime enforcer Joey Zasa. He uses his wealth in an attempt
									to rehabilitate his reputation through numerous philanthropic acts, administered by
									a foundation named after his father. A decade earlier, he gave custody of his two
						...
						<div className="card card-w-title">
							...
							<Panel header="Godfather I" toggleable={true}>
								The story begins as Don Vito Corleone, the head of a New York Mafia family, oversees his
								daughter's wedding. His beloved son Michael has just come home from the war, but does
								not intend to become part of his father's business. Through Michael's life the nature of
								the family business becomes clear. The business of the family is just like the head of
								the family, kind and benevolent to those who give respect, but given to ruthless
...
export default withSecurity(withSecureLayout(SampleDemo));
