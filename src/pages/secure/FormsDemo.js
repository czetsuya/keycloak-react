	...
	autoCompleteItemTemplate(brand) {
		...
		return (
			<div className="p-clearfix">
				<img
					alt={brand}
					src={`assets/demo/images/car/${brand}.gif`}
			...
			<div className="p-grid p-fluid">
				<div className="p-col-12 p-lg-6">
					<div className="card card-w-title">
						...
						<div className="p-grid form-group">
							...
							<div className="p-col-12 p-md-4">
								<span className="md-inputfield">
									<InputText className="p-error" placeholder="Invalid" />
								</span>
							</div>
						</div>
						...
						<div className="p-grid">
							...
							<div className="p-col-12">
								<AutoComplete
									...
									onChange={event => this.setState({ brand: event.value, filteredBrands: null })}
					...
					<div className="card card-w-title">
						...
						<MultiSelect
							...
							placeholder="Choose"
							onChange={event => this.setState({ cars: event.value })}
							filter={true}
						/>
					</div>
					...
					<div className="card card-w-title">
						...
						<div className="p-grid form-group-m" style={{ marginTop: '20px' }}>
							<div className="p-col-12">
								<Calendar
									placeholder="Popup"
							...
							<div className="p-col-12">
								<Calendar
									...
									onChange={e => this.setState({ date5: e.value })}
								/>
							</div>
							<div className="p-col-12">
								<Calendar
									...
									onChange={e => this.setState({ date6: e.value })}
								/>
							</div>
							<div className="p-col-12">
								<Calendar
									...
									onChange={e => this.setState({ date7: e.value })}
								/>
							</div>
						</div>
					</div>
				...
				<div className="p-col-12 p-lg-6">
					...
					<div className="card card-w-title">
						<h1>InputSwitch</h1>
						<InputSwitch
							checked={this.state.inputSwitchValue}
							onChange={event => this.setState({ inputSwitchValue: event.value })}
						/>
					</div>
					...
					<div className="card card-w-title">
						...
						<Rating
							...
							onChange={event => this.setState({ ratingValue: event.value })}
						/>
					</div>
					...
					<div className="card card-w-title">
						...
						<ColorPicker
							...
							onChange={event => this.setState({ colorPickerValue: event.value })}
						/>
					</div>
				</div>
							...
							<div className="p-col-12 p-md-6">
								<div className="p-inputgroup">
									<span className="p-inputgroup-addon p-inputgroup-addon-checkbox">
										<Checkbox
											checked={this.state.inputGroupValue}
											onChange={event => this.setState({ inputGroupValue: event.checked })}
										/>
									</span>
						...
						<div className="p-col-12 p-lg-6">
							<div className="card card-w-title">
								...
								<div className="p-grid">
									...
									<div className="p-col-12">
										<Button label="Clear" icon="pi-md-close" />
									</div>

									<div className="p-col-12">Right Icon</div>
									<div className="p-col-12">
										<Button label="Clear" icon="pi-md-close" iconPos="right" />
									</div>

									<div className="p-col-12">Icon Only</div>
									<div className="p-col-12">
										<Button icon="pi-md-check" />
									</div>

									<div className="p-col-12">Link</div>
									<div className="p-col-12">
										<a href="http://www.primefaces.org">Homepage</a>
									</div>
									...
									<div className="p-col-12">
										<SplitButton
											label="Save"
											icon="pi-md-plus"
											model={this.state.splitButtonItems}
										/>
									</div>
								</div>
							</div>
							...
							<div className="card card-w-title">
								...
								<div className="p-grid">
									<div className="p-col-12 p-md-6" style={{ textAlign: 'center' }}>
										<Button label="Primary" style={{ marginBottom: 10 }} />
										<Button label="Inline" style={{ marginBottom: 10, width: 'auto' }} />
										<Button
											label="Secondary"
										...
										/>
										<Button
											label="Blue-Grey Button"
											style={{ marginBottom: 10 }}
											className="blue-grey-btn flat-btn"
										/>
									...
									<div className="p-col-12 p-md-6" style={{ textAlign: 'center' }}>
										...
										<Button
											label="Secondary"
											style={{ marginBottom: 10 }}
											className="p-button-secondary flat-btn"
										/>
										<Button
											label="Green / Success"
											style={{ marginBottom: 10 }}
											className="p-button-success flat-btn"
										/>
										<Button
											label="Blue /Info"
											style={{ marginBottom: 10 }}
											className="p-button-info flat-btn"
										/>
										<Button
											label="Amber / Warning"
											style={{ marginBottom: 10 }}
											className="p-button-warning flat-btn"
										/>
										<Button
											label="Red / Danger"
											style={{ marginBottom: 10 }}
										...
										<Button
											label="Cyan Button"
											style={{ marginBottom: 10 }}
											className="cyan-btn flat-btn"
										/>
										<Button
											label="Teal Button"
											style={{ marginBottom: 10 }}
											className="teal-btn flat-btn"
										/>
										<Button
											label="Orange Button"
											style={{ marginBottom: 10 }}
											className="orange-btn flat-btn"
										/>
										<Button
											label="Deep-Orange Button"
											style={{ marginBottom: 10 }}
											className="deep-orange-btn flat-btn"
										/>
										<Button
											label="Purple Button"
											style={{ marginBottom: 10 }}
											className="purple-btn flat-btn"
										/>
										<Button
											label="Indigo Button"
											style={{ marginBottom: 10 }}
											className="indigo-btn flat-btn"
										/>
										<Button
											label="Pink Button"
											style={{ marginBottom: 10 }}
											className="pink-btn flat-btn"
										/>
									</div>
								</div>
							</div>
...
export default withSecurity(withSecureLayout(FormsDemo));
